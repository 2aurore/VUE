  ...
  <div class="black-bg" v-if="joinStatus">
    <div class="white-bg">
      ...
      <ul>
        ...
        <li>
          street <input v-model="street" />
        </li>
        <li>
          post code <input v-model="zipcode" />
        </li>
      </ul>
      <v-btn large @click="joinStatus = false" >CANCEL</v-btn>
      <v-btn large @click="onClickJoin" >SUBMIT</v-btn>
    </div>
  </div>
  ...
  <div class="login">
    <div>
      ...
      <div>
        ...
        <v-btn large @click="onClickLogin" >GO</v-btn>
        <v-btn large @click="joinStatus = true" >Join us</v-btn>
      </div>
    </div>
  </div>
